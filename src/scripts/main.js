...
const eventDate = new Date("Jun 19, 2024 08:00:00");
...
const dateCount = setInterval(function () {
    ...
    if (eventDistance < 0) {
        ...
        document.getElementById("hero__text").innerHTML =
            "O aniversário deste ano já passou, mas ano que vêm tem mais! Nos vemos na próxima";
    }
}, 1000);
